    ...
    <div className='about' id='about'>
      ...
      <div className='about-box3-size'>
        ...
        <div className='more-details'>
          ...
          <div className='icons'>
          <div className='row'>
           <div className='concept col-lg-2 col-sm-6'><img src='1.png'/><p>Concept</p></div>
           <div className='design col-lg-2 col-sm-6'><img src='2.png'/><p>Design</p></div>
           <div className='engineer col-lg-2 col-sm-6'><img src='3.png'/><p>Engineer</p></div>
            <div className='develop col-lg-2 col-sm-6' ><img  src='4.png'/><p>Develop</p></div>
            <div className='maintain col-lg-2 col-sm-12'><img src='5.png'/><p>Maintain</p></div>
            </div>
          </div>
        </div>
      </div>
