    ...
    <div className='footer' id="connect">
      <div className='info-section'>
        ...
        <div className='row-2 row'>
          ...
          <div className='row-2-2 col-lg-3 col-md-6'> <p>Talk to me</p> <a href='/' > <span> <i className="fa fa-phone" aria-hidden="true"></i> </span> +1 (913) 5866036</a> 
          </div>
          ...
          <a href='/' target='_blank' > <span> <i className="fa fa-linkedin-square" aria-hidden="true"></i> </span> /IN/RANDOMPERSON </a>
          </div>
        </div>
